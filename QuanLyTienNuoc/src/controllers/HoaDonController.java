...
public class HoaDonController {
    ...
    public static void setDataAndEventToTableHoaDon() {
        ...
        "Ngày Đầu", "Ngày Cuối", "Lượng nước tiêu thụ", "Tổng tiền", "Ngày lập phiếu", "Thanh toán", "Mã Nhân Viên"};
    ...
    private static long tinhTienNuoc(int chiSoCu, int chiSoMoi, int loaiNuoc) {
        ...
        long bill = 0;
        // Giá nước sinh hoạt
        final int[][] giaNuocSinhHoat = {{1, 5973},
                            {10, 7000},
                            {20, 8700},
                            {30, 16000}};
        // Giá nước Kinh doanh
        final int giaNuocKinhDoanh = 22000;
        //Giá nước Sản xuất
        final int giaNuocSanXuat = 11600;
        
        // Tính giá nước
        // loaiNuoc: 0-Sinh hoạt, 1-Sản xuất, 2-Kinh doanh
        ...
        switch(loaiNuoc){
            ...
            case 1 -> {
                bill = luongNuocTieuThu * giaNuocSanXuat;
            }
            case 2 -> {
